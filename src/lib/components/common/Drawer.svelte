<script lang="ts">
	...
	let { show = $bindable(false), className = '', onClose = () => {}, children }: Props = $props();
...
<div
	...
	class="modal fixed right-0 {$isApp
		...
		: ''} left-0 bottom-0 bg-[#191919]/30 dark:bg-[#0F0F0F]/60 w-full h-screen max-h-[100dvh] flex justify-center z-999 overflow-hidden overscroll-contain"
